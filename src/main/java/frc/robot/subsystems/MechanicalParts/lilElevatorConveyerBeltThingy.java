...
public class lilElevatorConveyerBeltThingy extends SubsystemBase {
    ...
    public lilElevatorConveyerBeltThingy(){
        ...
        mBeltMotor = new CANSparkMax(Constants.ElevatorConveyerThing.ConveyerCanID, MotorType.kBrushless);
    ...
    public void shoot(){
        shootingTime = 250;//five seconds of moving at 20ms frames, TODO USE TIMERS SO THE ROBOT WORKS MORE CONSISTENTLY
    }
    ...
    public void periodic() {
        ...
        BeltMotorPidController.setReference(
            Constants.ElevatorConveyerThing.bingChillinVelocity,
